...
const VinylRecordList = () => {
  ...
  useEffect(() => {
    ...
    const currentProgress = Number((1 - currentDuration / maxDuration).toFixed(3));
  ...
  return (
    <>
      <p className="text-center w-100 text-white text-caption">
        {FormatUtil.formatTimeToMMSS(currentDuration)}
      </p>
      <div className="w-[1120px] -translate-x-[320px] flex gap-x-5 justify-center m-auto items-center">
